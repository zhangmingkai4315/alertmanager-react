        ...
        <div className={Styles.alertListGroup}>
            <table className="table ">
                ...
                <tr>
                    ...
                    <th className={Styles.sortTableHeader} onClick={()=>props.toggleAlertName()}> 告警名称 {props.sort.alertname?<i className="fa fa-sort-down"></i>:<i className="fa fa-sort-up"></i>}</th>
                    <th>详细信息</th>
                    <th><i className="fa fa-bar-chart"></i> 链接信息</th>
